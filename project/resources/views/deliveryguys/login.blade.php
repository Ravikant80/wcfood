...
<head>
    <meta charset="utf-8" />
    <title>DeliveryGuys | Log In</title>
...
<div class="content">
    <form method="POST" action="{{ route('DeliveryGuys.login.post') }}" class="login-form">
        @csrf
   
    <h3 class="form-title font-green">DeliveryGuys Log In</h3>
    ...
    <div class="form-group">
        ...
        <input class="form-control form-control-solid placeholder-no-fix" type="email" value="{{ old('email') }}" autocomplete="off" placeholder="Email" name="email" /> </div>
    <div class="form-group">
