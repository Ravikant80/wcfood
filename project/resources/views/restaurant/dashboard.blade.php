    ...
    <div class="page-header-inner ">
        ...
        <div class="top-menu">
            ...
            <ul class="nav navbar-nav pull-right">
                <li>
                    <a href="{{url('/getRestaurantNotification')}}">
                    <i class="fa fa-bell" aria-hidden="true" style="color:#C71585;">3</i>
                    </a>
                </li>
                <li class="dropdown dropdown-user">
                    ...
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="true">
                        ...
                        <span class="username"> Welcome, {!! Auth::guard('restaurant')->user()->name !!} </span>
                        </a>
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item start">
                    <a href="{{url('restaurant-dashboard') }}" class="nav-link ">
