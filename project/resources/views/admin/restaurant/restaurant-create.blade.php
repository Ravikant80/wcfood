    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body" style="overflow: hidden">
                ...
                <form method="post" id="add_restaurent_form_id" action=" {{ url('admin/store-restaurant') }}"  enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="required2" name="name" class="form-control" value="{{ old('name') }}" data-validation="length required" data-validation-length="min3"/>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4" >
                                        <div class="row">
                                            <div class="col-md-6">
                                                Price
                                                <select name="pricep" class="form-control" style="border-color: #468847;" required >  
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" id="required2" name="email" class="form-control"  data-validation="email required" value="{{ old('email') }}"/>
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="password" id="required2" name="password" class="form-control" required value="{{ old('password') }}" placeholder="Minimum 8 charcter" />
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="required2" name="descriptions" class="form-control" required  value="{{ old('descriptions') }}"/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="inputTextBox" name="cont_p_name" class="form-control" required  value="{{ old('cont_p_name') }}" maxlength="35" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" id="required2" name="cont_P_email" class="form-control" required  value="{{ old('cont_P_email') }}" data-validation="email required" />
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="tel" id="required2" name="cont_p_phone" class="form-control" required  value="{{ old('cont_p_phone') }}" onkeypress="return isNumberKey(event)" maxlength="10" required >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" id="required2" name="min_order_price" class="form-control" data-validation="required" value="{{ old('min_order_price') }}" min="1" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" id="searchInput" class="controls" placeholder="Enter a Postal Code" value="{{ old('full_address') }}" required/>
                                        <div id="map" style="width:80%;height:350px;"></div>
                                        <div id="geoData">
                                          <input type="hidden" name="full_address" id="location" value="{{ old('full_address') }}">
                                          <input type="hidden" name="postalcode" id="postal_code" value="{{ old('postalcode') }}">
                                          <input type="hidden" name="country" id="country" value="{{ old('country') }}">
                                          <input type="hidden" name="latitude" id="lat" value="{{ old('latitude') }}">
                                          <input type="hidden" name="longitude" id="lon" value="{{ old('longitude') }}">
                                      </div> 
                                  </div>
                              </div>
                          </div>
