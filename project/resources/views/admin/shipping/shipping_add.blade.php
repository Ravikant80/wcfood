    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body" style="overflow: hidden">
                ...
                <form method="post" id="add_restaurent_form_id" action="{{ url('admin/shipping-store') }}"  enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                  <input type="text" id="countryid" name="country" class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" required  value="india"/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" id="priceid" name="price" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}"  value="{{ old('price') }}" min="1" required  />
